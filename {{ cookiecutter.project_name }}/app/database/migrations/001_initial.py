...
def migrate(migrator, database, fake=False, **kwargs):
    ...
    class User(pw.Model):
        ...
        last_name = pw.CharField(max_length=64, null=True)
        username = pw.CharField(index=True, max_length=32, null=True)
        language_code = pw.CharField(max_length=4, null=True)
